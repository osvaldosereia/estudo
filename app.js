...
/* ========= Floating Search Index =========
   Mostra um botão ao lado direito sob a topbar quando há resultados.
   Se houver resultados de 3+ ARQUIVOS diferentes, vira um menu retrátil.
*/
(function(){
